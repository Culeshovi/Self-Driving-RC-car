#If webcam does'nt work set it to -1 or 1
...
def process_img(image):
    ...
    vertices = np.array([[10,200],[10,480],[630,480],[630,200]
                         ], np.int32)
    ...
    lines = cv2.HoughLinesP(processed_img, 1, np.pi/180, 180,2,5)
    m1 = 0
    m2 = 0
    try:
...
while(True):
    ...
    cv2.imshow('pros',cv2.cvtColor(original_image, cv2.COLOR_BGR2RGB))
